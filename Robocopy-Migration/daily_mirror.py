...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run daily strict 1:1 mirror copy with robocopy."
    )
    parser.add_argument(
        "--source",
        default=None,
...
def main() -> int:
    ...
    report_file = report_dir / DAILY_HISTORY_FILE_NAME
    ...
    print("Starting daily strict mirror copy...")
